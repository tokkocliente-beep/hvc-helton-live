...
# o Neon (banco gratuito) fecha conexões paradas por um tempo pra economizar
# recursos — sem isso, o SQLAlchemy tenta reaproveitar uma conexão já morta
# e quebra com "SSL connection has been closed unexpectedly". pool_pre_ping
# testa a conexão antes de cada uso e reconecta sozinho se precisar;
# pool_recycle força renovar antes do Neon fechar por conta própria.
